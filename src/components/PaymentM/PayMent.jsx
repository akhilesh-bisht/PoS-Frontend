    ...
    <section id="payments" className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex items-center md:gap-4">
          ...
          <button className="bg-blue-600 text-white text-xs px-0.5  w-[216px] md:w-44 lg:w-60 py-1 rounded-lg flex items-center gap-1 hover:bg-blue-700 transition-colors focus:outline-none ml-1">
            <svg
